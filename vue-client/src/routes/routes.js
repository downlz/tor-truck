...
//Fleet Components pages
const ScheduleDispatch = ()=>  import('@/pages/Dashboard/Fleet/ScheduleDispatch.vue');
const ActiveTrips = ()=>  import('@/pages/Dashboard/Fleet/ActiveTrips.vue');
const TripHistory = ()=>  import('@/pages/Dashboard/Fleet/TripHistory.vue');
const EditTrip = ()=>  import('@/pages/Dashboard/Fleet/EditTrip.vue');

const AddTrucks = ()=>  import('@/pages/Dashboard/Fleet/AddTrucks.vue');
const PreferredRoutes = ()=>  import('@/pages/Dashboard/Fleet/PreferredRoutes.vue');
const MaterialDispatch = ()=>  import('@/pages/Dashboard/Fleet/MaterialDispatch.vue');

const RaiseDemand = ()=>  import('@/pages/Dashboard/Fleet/RaiseDemand.vue');
const OfferFleet = ()=>  import('@/pages/Dashboard/Fleet/OfferFleet.vue');
...
let manageTripMenu = {
  ...
  component: DashboardLayout,
  name: 'Manage Trip',
  redirect: '/fleet/triphistory',
  children: [
    {
      path: 'scheduledispatch',
      name: 'Schedule Dispatch',
      components: {default: ScheduleDispatch}
    },
    {
      path: 'activetrips',
      name: 'Active Trips',
      components: {default: ActiveTrips}
    },
    {
      path: 'triphistory',
      name: 'Trip History',
      components: {default: TripHistory}
    },
    {
      path: 'edittrip',
      name: 'Edit Trip',
  ...
  children: [
    {
      path: 'addtrucks',
      name: 'Add Trucks',
      components: {default: AddTrucks}
    },
    {
      path: 'preferredroutes',
      name: 'Preferred Routes',
      components: {default: PreferredRoutes}
    },
    {
      path: 'materialdispatch',
      name: 'Load Material Dispatch',
      components: {default: MaterialDispatch}
    }
  ]
}
  ...
  children: [
    {
      path: 'raisedemand',
      name: 'Raise a demand',
      components: {default: RaiseDemand}
    },
    {
      path: 'offerfleet',
      name: 'Offer Fleet',
      components: {default: OfferFleet}
    }
  ]
}
